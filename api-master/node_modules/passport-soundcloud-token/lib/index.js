...
var SoundCloudTokenStrategy = function (_OAuth2Strategy) {
  _inherits(SoundCloudTokenStrategy, _OAuth2Strategy);

  function SoundCloudTokenStrategy(_options, _verify) {
    _classCallCheck(this, SoundCloudTokenStrategy);
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SoundCloudTokenStrategy).call(this, options, verify));

    _this.name = 'soundcloud-token';
    ...
    _this._profileURL = options.profileURL || 'https://api.soundcloud.com/me.json';
  ...
  _createClass(SoundCloudTokenStrategy, [{
    key: 'authenticate',
      ...
      this._oauth2.get(this._profileURL, accessToken, function (error, body, res) {
        if (error) {
          try {
            ...
            return done(new _passportOauth.InternalOAuthError(errorJSON.errors[0].error_message, error.statusCode));
          } catch (_) {
  ...
  return SoundCloudTokenStrategy;
}(_passportOauth.OAuth2Strategy);

exports.default = SoundCloudTokenStrategy;
