...
var TwitchTokenStrategy = function (_OAuth2Strategy) {
  _inherits(TwitchTokenStrategy, _OAuth2Strategy);

  function TwitchTokenStrategy(_options, _verify) {
    _classCallCheck(this, TwitchTokenStrategy);
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TwitchTokenStrategy).call(this, options, verify));

    _this.name = 'twitch-token';
    ...
    _this._profileURL = options.profileURL || 'https://api.twitch.tv/kraken/user';
    _this._passReqToCallback = options.passReqToCallback;

    _this._oauth2.setAuthMethod('OAuth');
  ...
  _createClass(TwitchTokenStrategy, [{
    key: 'authenticate',
      ...
      this._oauth2.get(this._profileURL, accessToken, function (error, body, res) {
        if (error) {
          try {
            ...
            return done(new _passportOauth.InternalOAuthError(errorJSON.message, errorJSON.status));
          } catch (_) {
  ...
  return TwitchTokenStrategy;
}(_passportOauth.OAuth2Strategy);

exports.default = TwitchTokenStrategy;
;
